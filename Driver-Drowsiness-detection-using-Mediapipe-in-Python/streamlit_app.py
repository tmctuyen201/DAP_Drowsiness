...
# from ads import css_stringx

# Define the audio file to use.
# alarm_file_path = os.path.join("audio", "wake_up.wav")
alarm_file_path = '/Users/daoxuanbac/Desktop/Python/SU23_DAP/Driver-Drowsiness-detection-using-Mediapipe-in-Python/audio/wake_up.wav'
